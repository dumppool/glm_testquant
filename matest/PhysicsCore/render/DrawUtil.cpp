...
void cDrawUtil::DrawRect(const tVector& pos, const tVector& size, eDrawMode draw_mode)
{
 ...
 void cDrawUtil::DrawBox(const tVector& pos, const tVector& size, 
	const tVector& tex_coord_min,  const tVector& tex_coord_max, eDrawMode draw_mode)
 { 
   DrawBox(  pos,   size,  draw_mode);
 }		
