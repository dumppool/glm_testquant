...
void cDrawScene::InitRenderResources()
{
	...
	{
		//KHAdd mShaderDepth = std::unique_ptr<cShader>(new cShader());
		//KHAdd succ &= mShaderDepth->BuildShader("data/shaders/Mesh_VS.glsl", "data/shaders/Depth_PS.glsl");
	}
