...
#define SWIGTYPE_p_cTextureDesc swig_types[3]
...
#define SWIGTYPE_p_reference swig_types[10]
#define SWIGTYPE_p_size_type swig_types[11]
#define SWIGTYPE_p_std__allocatorT_char_const_p_t swig_types[12]
#define SWIGTYPE_p_std__allocatorT_double_t swig_types[13]
#define SWIGTYPE_p_std__allocatorT_int_t swig_types[14]
#define SWIGTYPE_p_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t swig_types[15]
...
#define SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t swig_types[19]
#define SWIGTYPE_p_std__vectorT_char_const_p_std__allocatorT_char_const_p_t_t swig_types[20]
...
SWIGINTERN void std_vector_Sl_std_string_Sg__insert__SWIG_1(std::vector< std::string > *self,std::vector< std::string >::iterator pos,std::vector< std::string >::size_type n,std::vector< std::string >::value_type const &x){ self->insert(pos, n, x); }
  ...
  namespace swig {
	...
	return obj;
      ...
      namespace swig {
	template <>  struct traits<std::pair< std::string, std::vector< std::string,std::allocator< std::string > > > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::pair<" "std::string" "," "std::vector< std::string,std::allocator< std::string > >" " >";
	  }
	};
      }
  ...
  namespace swig {
	...
	if (desc && desc->clientdata) {
      ...
      namespace swig {
	template <>  struct traits<std::map< std::string, std::vector< std::string,std::allocator< std::string > >, std::less< std::string >, std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > > {
	  typedef pointer_category category;
	  static const char* type_name() {
	    return "std::map<" "std::string" "," "std::vector< std::string,std::allocator< std::string > >" "," "std::less< std::string >" "," "std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > >" " >";
	  }
	};
      }
    
SWIGINTERN swig::SwigPyIterator *std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__iterator(std::map< std::string,std::vector< std::string > > *self,PyObject **PYTHON_SELF){
      return swig::make_output_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN bool std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____nonzero__(std::map< std::string,std::vector< std::string > > const *self){
      return !(self->empty());
    }
SWIGINTERN bool std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____bool__(std::map< std::string,std::vector< std::string > > const *self){
      return !(self->empty());
    }
SWIGINTERN std::map< std::string,std::vector< std::string > >::size_type std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____len__(std::map< std::string,std::vector< std::string > > const *self){
      return self->size();
    }
SWIGINTERN std::map< std::string,std::vector< std::string > >::mapped_type const &std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____getitem__(std::map< std::string,std::vector< std::string > > *self,std::map< std::string,std::vector< std::string > >::key_type const &key){
      std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::const_iterator i = self->find(key);
      if (i != self->end())
	return i->second;
      else
	throw std::out_of_range("key not found");
    }
SWIGINTERN void std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____delitem__(std::map< std::string,std::vector< std::string > > *self,std::map< std::string,std::vector< std::string > >::key_type const &key){
      std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::iterator i = self->find(key);
      if (i != self->end())
	self->erase(i);
      else
	throw std::out_of_range("key not found");
    }
SWIGINTERN bool std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__has_key(std::map< std::string,std::vector< std::string > > const *self,std::map< std::string,std::vector< std::string > >::key_type const &key){
      std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::const_iterator i = self->find(key);
      return i != self->end();
    }
SWIGINTERN PyObject *std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__keys(std::map< std::string,std::vector< std::string > > *self){
      std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::size_type size = self->size();
      Py_ssize_t pysize = (size <= (std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::size_type) INT_MAX) ? (Py_ssize_t) size : -1;
      SWIG_PYTHON_THREAD_BEGIN_BLOCK;
      if (pysize < 0) {
	PyErr_SetString(PyExc_OverflowError, "map size not valid in python");
	SWIG_PYTHON_THREAD_END_BLOCK;
	return NULL;
      ...
      std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::const_iterator i = self->begin();
...
SWIGINTERN PyObject *std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__values(std::map< std::string,std::vector< std::string > > *self){
      std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::size_type size = self->size();
      Py_ssize_t pysize = (size <= (std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::size_type) INT_MAX) ? (Py_ssize_t) size : -1;
      SWIG_PYTHON_THREAD_BEGIN_BLOCK;
      if (pysize < 0) {
...
SWIGINTERN PyObject *std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__items(std::map< std::string,std::vector< std::string > > *self){
      std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::size_type size = self->size();
      Py_ssize_t pysize = (size <= (std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >::size_type) INT_MAX) ? (Py_ssize_t) size : -1;
      SWIG_PYTHON_THREAD_BEGIN_BLOCK;
      if (pysize < 0) {
...
SWIGINTERN bool std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____contains__(std::map< std::string,std::vector< std::string > > *self,std::map< std::string,std::vector< std::string > >::key_type const &key){
      return self->find(key) != self->end();
    }
SWIGINTERN swig::SwigPyIterator *std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__key_iterator(std::map< std::string,std::vector< std::string > > *self,PyObject **PYTHON_SELF){
      return swig::make_output_key_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN swig::SwigPyIterator *std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__value_iterator(std::map< std::string,std::vector< std::string > > *self,PyObject **PYTHON_SELF){
      return swig::make_output_value_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN void std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____setitem____SWIG_0(std::map< std::string,std::vector< std::string > > *self,std::map< std::string,std::vector< std::string > >::key_type const &key){
      self->erase(key);
    }
SWIGINTERN void std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____setitem____SWIG_1(std::map< std::string,std::vector< std::string > > *self,std::map< std::string,std::vector< std::string > >::key_type const &key,std::map< std::string,std::vector< std::string > >::mapped_type const &x){
      (*self)[key] = x;
    }
SWIGINTERN PyObject *std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__asdict(std::map< std::string,std::vector< std::string > > *self){
      return swig::traits_from< std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > >::asdict(*self);
    }
SWIGINTERN void std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__erase__SWIG_1(std::map< std::string,std::vector< std::string > > *self,std::map< std::string,std::vector< std::string > >::iterator position){ self->erase(position); }
SWIGINTERN void std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__erase__SWIG_2(std::map< std::string,std::vector< std::string > > *self,std::map< std::string,std::vector< std::string > >::iterator first,std::map< std::string,std::vector< std::string > >::iterator last){ self->erase(first, last); }
...
SWIGINTERN PyObject *_wrap_new_MapStringVectorString__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:new_MapStringVectorString",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_std__lessT_std__string_t,  0  | 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_MapStringVectorString" "', argument " "1"" of type '" "std::less< std::string > const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_MapStringVectorString" "', argument " "1"" of type '" "std::less< std::string > const &""'"); 
  }
  arg1 = reinterpret_cast< std::less< std::string > * >(argp1);
  result = (std::map< std::string,std::vector< std::string > > *)new std::map< std::string,std::vector< std::string > >((std::less< std::string > const &)*arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  arg2 = &obj0;
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_iterator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_iterator" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (swig::SwigPyIterator *)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___nonzero__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString___nonzero__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString___nonzero__" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (bool)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____nonzero__((std::map< std::string,std::vector< std::string > > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___bool__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString___bool__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString___bool__" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (bool)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____bool__((std::map< std::string,std::vector< std::string > > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___len__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString___len__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString___len__" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____len__((std::map< std::string,std::vector< std::string > > const *)arg1);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___getitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString___getitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString___getitem__" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString___getitem__" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString___getitem__" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  try {
    result = (std::map< std::string,std::vector< std::string > >::mapped_type *) &std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____getitem__(arg1,(std::string const &)*arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___delitem__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString___delitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString___delitem__" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString___delitem__" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString___delitem__" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  try {
    std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____delitem__(arg1,(std::string const &)*arg2);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_has_key(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString_has_key",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_has_key" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString_has_key" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString_has_key" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  result = (bool)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__has_key((std::map< std::string,std::vector< std::string > > const *)arg1,(std::string const &)*arg2);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_keys(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_keys",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_keys" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (PyObject *)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__keys(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_values(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_values",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_values" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (PyObject *)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__values(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_items(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_items",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_items" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (PyObject *)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__items(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___contains__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString___contains__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString___contains__" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString___contains__" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString___contains__" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  result = (bool)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____contains__(arg1,(std::string const &)*arg2);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_key_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  PyObject **arg2 = (PyObject **) 0 ;
  void *argp1 = 0 ;
  ...
  arg2 = &obj0;
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_key_iterator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_key_iterator" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (swig::SwigPyIterator *)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__key_iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_value_iterator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  PyObject **arg2 = (PyObject **) 0 ;
  void *argp1 = 0 ;
  ...
  arg2 = &obj0;
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_value_iterator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_value_iterator" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (swig::SwigPyIterator *)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__value_iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___setitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString___setitem__",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString___setitem__" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString___setitem__" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString___setitem__" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____setitem____SWIG_0(arg1,(std::string const &)*arg2);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___setitem____SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MapStringVectorString___setitem__",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString___setitem__" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  ...
  }
  {
    ...
    res3 = swig::asptr(obj2, &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "MapStringVectorString___setitem__" "', argument " "3"" of type '" "std::map< std::string,std::vector< std::string > >::mapped_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString___setitem__" "', argument " "3"" of type '" "std::map< std::string,std::vector< std::string > >::mapped_type const &""'"); 
    }
    arg3 = ptr;
  }
  try {
    std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg____setitem____SWIG_1(arg1,(std::string const &)*arg2,(std::vector< std::string,std::allocator< std::string > > const &)*arg3);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_MapStringVectorString___setitem__(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[4] = {
    0
  };
  ...
  if (argc == 2) {
    int _v;
    int res = swig::asptr(argv[0], (std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > >**)(0));
    _v = SWIG_CheckState(res);
    if (_v) {
      int res = SWIG_AsPtr_std_string(argv[1], (std::string**)(0));
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_MapStringVectorString___setitem____SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_MapStringVectorString___setitem____SWIG_1(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MapStringVectorString___setitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_asdict(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_asdict",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_asdict" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (PyObject *)std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__asdict(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_MapStringVectorString__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_MapStringVectorString")) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_new_MapStringVectorString__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string,std::allocator< std::string > > > *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  std::map< std::string,std::vector< std::string > > *result = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:new_MapStringVectorString",&obj0)) SWIG_fail;
  {
    std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > *ptr = (std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > *)0;
    res1 = swig::asptr(obj0, &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_MapStringVectorString" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string,std::allocator< std::string > > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_MapStringVectorString" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string,std::allocator< std::string > > > const &""'"); 
    }
    arg1 = ptr;
  }
  result = (std::map< std::string,std::vector< std::string > > *)new std::map< std::string,std::vector< std::string > >((std::map< std::string,std::vector< std::string,std::allocator< std::string > > > const &)*arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, SWIG_POINTER_NEW |  0 );
  if (SWIG_IsNewObj(res1)) delete arg1;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_new_MapStringVectorString(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[2] = {
    0
  };
  ...
  if (argc == 0) {
    return _wrap_new_MapStringVectorString__SWIG_1(self, args);
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_MapStringVectorString__SWIG_0(self, args);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_MapStringVectorString__SWIG_2(self, args);
    }
  }
  
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_MapStringVectorString'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_empty(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_empty",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_empty" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_size(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_size",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_size" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_swap(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string,std::allocator< std::string > > > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString_swap",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_swap" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2, SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString_swap" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string,std::allocator< std::string > > > &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString_swap" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string,std::allocator< std::string > > > &""'"); 
  }
  arg2 = reinterpret_cast< std::map< std::string,std::vector< std::string,std::allocator< std::string > > > * >(argp2);
  (arg1)->swap(*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_begin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_begin",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_begin" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (arg1)->begin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< std::string,std::vector< std::string > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_end(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_end",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_end" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (arg1)->end();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< std::string,std::vector< std::string > >::iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_rbegin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  std::map< std::string,std::vector< std::string > >::reverse_iterator result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_rbegin",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_rbegin" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (arg1)->rbegin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< std::string,std::vector< std::string > >::reverse_iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_rend(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_rend",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_rend" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = (arg1)->rend();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< std::string,std::vector< std::string > >::reverse_iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_clear(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_clear",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_clear" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  (arg1)->clear();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_get_allocator(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject * obj0 = 0 ;
  SwigValueWrapper< std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > result;
  
  if (!PyArg_ParseTuple(args,(char *)"O:MapStringVectorString_get_allocator",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_get_allocator" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  result = ((std::map< std::string,std::vector< std::string > > const *)arg1)->get_allocator();
  resultobj = SWIG_NewPointerObj((new std::map< std::string,std::vector< std::string > >::allocator_type(static_cast< const std::map< std::string,std::vector< std::string > >::allocator_type& >(result))), SWIGTYPE_p_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_erase__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString_erase",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_erase" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString_erase" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString_erase" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  result = (arg1)->erase((std::map< std::string,std::vector< std::string > >::key_type const &)*arg2);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_count(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString_count",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_count" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString_count" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString_count" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  result = ((std::map< std::string,std::vector< std::string > > const *)arg1)->count((std::map< std::string,std::vector< std::string > >::key_type const &)*arg2);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_erase__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::iterator arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  res2 = SWIG_ConvertPtr(obj1, SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MapStringVectorString_erase" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::map< std::string,std::vector< std::string > >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::map< std::string,std::vector< std::string > >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MapStringVectorString_erase" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::iterator""'");
  ...
  std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__erase__SWIG_1(arg1,arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_erase__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::iterator arg2 ;
  std::map< std::string,std::vector< std::string > >::iterator arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:MapStringVectorString_erase",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_erase" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  ...
  res3 = SWIG_ConvertPtr(obj2, SWIG_as_voidptrptr(&iter3), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res3) || !iter3) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MapStringVectorString_erase" "', argument " "3"" of type '" "std::map< std::string,std::vector< std::string > >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::map< std::string,std::vector< std::string > >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::map< std::string,std::vector< std::string > >::iterator > *>(iter3);
    if (iter_t) {
      arg3 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "MapStringVectorString_erase" "', argument " "3"" of type '" "std::map< std::string,std::vector< std::string > >::iterator""'");
  ...
  std_map_Sl_std_string_Sc_std_vector_Sl_std_string_Sg__Sg__erase__SWIG_2(arg1,arg2,arg3);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_erase(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[4] = {
    0
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      swig::SwigPyIterator *iter = 0;
      int res = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter), swig::SwigPyIterator::descriptor(), 0);
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::map< std::string,std::vector< std::string > >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_MapStringVectorString_erase__SWIG_1(self, args);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_MapStringVectorString_erase__SWIG_0(self, args);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::map< std::string,std::vector< std::string > >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_MapStringVectorString_erase__SWIG_2(self, args);
        }
      }
    }
  }
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'MapStringVectorString_erase'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_find(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString_find",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_find" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString_find" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString_find" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  result = (arg1)->find((std::map< std::string,std::vector< std::string > >::key_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< std::string,std::vector< std::string > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_lower_bound(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString_lower_bound",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_lower_bound" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString_lower_bound" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString_lower_bound" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  result = (arg1)->lower_bound((std::map< std::string,std::vector< std::string > >::key_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< std::string,std::vector< std::string > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
...
SWIGINTERN PyObject *_wrap_MapStringVectorString_upper_bound(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  std::map< std::string,std::vector< std::string > >::key_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:MapStringVectorString_upper_bound",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapStringVectorString_upper_bound" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "MapStringVectorString_upper_bound" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MapStringVectorString_upper_bound" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string > >::key_type const &""'"); 
    }
    arg2 = ptr;
  }
  result = (arg1)->upper_bound((std::map< std::string,std::vector< std::string > >::key_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::map< std::string,std::vector< std::string > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
...
SWIGINTERN PyObject *_wrap_delete_MapStringVectorString(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::map< std::string,std::vector< std::string > > *arg1 = (std::map< std::string,std::vector< std::string > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_MapStringVectorString",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_MapStringVectorString" "', argument " "1"" of type '" "std::map< std::string,std::vector< std::string > > *""'"); 
  }
  arg1 = reinterpret_cast< std::map< std::string,std::vector< std::string > > * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *MapStringVectorString_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_std__mapT_std__string_std__vectorT_std__string_std__allocatorT_std__string_t_t_std__lessT_std__string_t_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
SWIGINTERN PyObject *_wrap_cTextureDesc_testAA_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cTextureDesc *arg1 = (cTextureDesc *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int val2 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cTextureDesc_testAA_set",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cTextureDesc, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cTextureDesc_testAA_set" "', argument " "1"" of type '" "cTextureDesc *""'"); 
  }
  arg1 = reinterpret_cast< cTextureDesc * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "cTextureDesc_testAA_set" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  if (arg1) (arg1)->testAA = arg2;
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_cTextureDesc_testAA_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cTextureDesc *arg1 = (cTextureDesc *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cTextureDesc_testAA_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cTextureDesc, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cTextureDesc_testAA_get" "', argument " "1"" of type '" "cTextureDesc *""'"); 
  }
  arg1 = reinterpret_cast< cTextureDesc * >(argp1);
  result = (int) ((arg1)->testAA);
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_new_cTextureDesc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cTextureDesc *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_cTextureDesc")) SWIG_fail;
  result = (cTextureDesc *)new cTextureDesc();
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_cTextureDesc, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_delete_cTextureDesc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cTextureDesc *arg1 = (cTextureDesc *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_cTextureDesc",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cTextureDesc, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_cTextureDesc" "', argument " "1"" of type '" "cTextureDesc *""'"); 
  }
  arg1 = reinterpret_cast< cTextureDesc * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *cTextureDesc_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!PyArg_ParseTuple(args,(char*)"O:swigregister", &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_cTextureDesc, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
SWIGINTERN PyObject *_wrap_new_cDeepMimicCore(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:new_cDeepMimicCore",&obj0)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_delete_cDeepMimicCore(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:delete_cDeepMimicCore",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_SeedRand(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_SeedRand",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_ParseArgs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_ParseArgs",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_SetArgs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cDeepMimicCore *arg1 = (cDeepMimicCore *) 0 ;
  std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int res2 = SWIG_OLDOBJ ;
  PyObject * obj0 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_SetArgs",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cDeepMimicCore_SetArgs" "', argument " "1"" of type '" "cDeepMimicCore *""'"); 
  }
  arg1 = reinterpret_cast< cDeepMimicCore * >(argp1);
  {
    std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > *ptr = (std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > *)0;
    res2 = swig::asptr(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "cDeepMimicCore_SetArgs" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "cDeepMimicCore_SetArgs" "', argument " "2"" of type '" "std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > const &""'"); 
    }
    arg2 = ptr;
  }
  (arg1)->SetArgs((std::map< std::string,std::vector< std::string,std::allocator< std::string > >,std::less< std::string >,std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > > const &)*arg2);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_Init(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_Init",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_Update(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_Update",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_Reset(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_Reset",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetTime(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_GetTime",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetKinTime(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cDeepMimicCore *arg1 = (cDeepMimicCore *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_GetKinTime",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cDeepMimicCore_GetKinTime" "', argument " "1"" of type '" "cDeepMimicCore const *""'"); 
  }
  arg1 = reinterpret_cast< cDeepMimicCore * >(argp1);
  result = (double)((cDeepMimicCore const *)arg1)->GetKinTime();
  resultobj = SWIG_From_double(static_cast< double >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetName(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_GetName",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_EnableDraw(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_EnableDraw",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_Draw(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_Draw",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_Keyboard(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:cDeepMimicCore_Keyboard",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_MouseClick(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:cDeepMimicCore_MouseClick",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_MouseMove(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:cDeepMimicCore_MouseMove",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_Reshape(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:cDeepMimicCore_Reshape",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_Shutdown(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_Shutdown",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_IsDone(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_IsDone",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetDrawScene(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_GetDrawScene",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_SetPlaybackSpeed(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_SetPlaybackSpeed",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_SetUpdatesPerSec(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_SetUpdatesPerSec",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetWinWidth(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_GetWinWidth",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetWinHeight(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_GetWinHeight",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetNumUpdateSubsteps(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_GetNumUpdateSubsteps",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_IsRLScene(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_IsRLScene",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetNumAgents(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_GetNumAgents",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_NeedNewAction(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_NeedNewAction",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_RecordState(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_RecordState",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_RecordGoal(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_RecordGoal",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_SetAction(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:cDeepMimicCore_SetAction",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_LogVal(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:cDeepMimicCore_LogVal",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetActionSpace(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetActionSpace",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetStateSize(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetStateSize",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetGoalSize(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetGoalSize",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetActionSize(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetActionSize",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetNumActions(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetNumActions",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildStateOffset(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildStateOffset",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildStateScale(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildStateScale",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildGoalOffset(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildGoalOffset",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildGoalScale(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildGoalScale",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildActionOffset(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildActionOffset",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildActionScale(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildActionScale",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildActionBoundMin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildActionBoundMin",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildActionBoundMax(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildActionBoundMax",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildStateNormGroups(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildStateNormGroups",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_BuildGoalNormGroups(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_BuildGoalNormGroups",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_CalcReward(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_CalcReward",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetRewardMin(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetRewardMin",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetRewardMax(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetRewardMax",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetRewardFail(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetRewardFail",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_GetRewardSucc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_GetRewardSucc",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_IsEpisodeEnd(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_IsEpisodeEnd",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_CheckValidEpisode(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_CheckValidEpisode",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_CheckTerminate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_CheckTerminate",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_SetMode(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_SetMode",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_SetSampleCount(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:cDeepMimicCore_SetSampleCount",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_cDeepMimicCore_PrintArgs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  cDeepMimicCore *arg1 = (cDeepMimicCore *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:cDeepMimicCore_PrintArgs",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_cDeepMimicCore, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cDeepMimicCore_PrintArgs" "', argument " "1"" of type '" "cDeepMimicCore const *""'"); 
  }
  arg1 = reinterpret_cast< cDeepMimicCore * >(argp1);
  ((cDeepMimicCore const *)arg1)->PrintArgs();
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"MapStringVectorString_iterator", _wrap_MapStringVectorString_iterator, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString___nonzero__", _wrap_MapStringVectorString___nonzero__, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString___bool__", _wrap_MapStringVectorString___bool__, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString___len__", _wrap_MapStringVectorString___len__, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString___getitem__", _wrap_MapStringVectorString___getitem__, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString___delitem__", _wrap_MapStringVectorString___delitem__, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_has_key", _wrap_MapStringVectorString_has_key, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_keys", _wrap_MapStringVectorString_keys, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_values", _wrap_MapStringVectorString_values, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_items", _wrap_MapStringVectorString_items, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString___contains__", _wrap_MapStringVectorString___contains__, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_key_iterator", _wrap_MapStringVectorString_key_iterator, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_value_iterator", _wrap_MapStringVectorString_value_iterator, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString___setitem__", _wrap_MapStringVectorString___setitem__, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_asdict", _wrap_MapStringVectorString_asdict, METH_VARARGS, NULL},
	 { (char *)"new_MapStringVectorString", _wrap_new_MapStringVectorString, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_empty", _wrap_MapStringVectorString_empty, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_size", _wrap_MapStringVectorString_size, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_swap", _wrap_MapStringVectorString_swap, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_begin", _wrap_MapStringVectorString_begin, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_end", _wrap_MapStringVectorString_end, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_rbegin", _wrap_MapStringVectorString_rbegin, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_rend", _wrap_MapStringVectorString_rend, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_clear", _wrap_MapStringVectorString_clear, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_get_allocator", _wrap_MapStringVectorString_get_allocator, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_count", _wrap_MapStringVectorString_count, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_erase", _wrap_MapStringVectorString_erase, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_find", _wrap_MapStringVectorString_find, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_lower_bound", _wrap_MapStringVectorString_lower_bound, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_upper_bound", _wrap_MapStringVectorString_upper_bound, METH_VARARGS, NULL},
	 { (char *)"delete_MapStringVectorString", _wrap_delete_MapStringVectorString, METH_VARARGS, NULL},
	 { (char *)"MapStringVectorString_swigregister", MapStringVectorString_swigregister, METH_VARARGS, NULL},
	 ...
	 { (char *)"cTextureDesc_testAA_set", _wrap_cTextureDesc_testAA_set, METH_VARARGS, NULL},
	 { (char *)"cTextureDesc_testAA_get", _wrap_cTextureDesc_testAA_get, METH_VARARGS, NULL},
	 { (char *)"new_cTextureDesc", _wrap_new_cTextureDesc, METH_VARARGS, NULL},
	 { (char *)"delete_cTextureDesc", _wrap_delete_cTextureDesc, METH_VARARGS, NULL},
	 { (char *)"cTextureDesc_swigregister", cTextureDesc_swigregister, METH_VARARGS, NULL},
	 { (char *)"new_cDeepMimicCore", _wrap_new_cDeepMimicCore, METH_VARARGS, NULL},
	 { (char *)"delete_cDeepMimicCore", _wrap_delete_cDeepMimicCore, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_SeedRand", _wrap_cDeepMimicCore_SeedRand, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_ParseArgs", _wrap_cDeepMimicCore_ParseArgs, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_SetArgs", _wrap_cDeepMimicCore_SetArgs, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_Init", _wrap_cDeepMimicCore_Init, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_Update", _wrap_cDeepMimicCore_Update, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_Reset", _wrap_cDeepMimicCore_Reset, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetTime", _wrap_cDeepMimicCore_GetTime, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetKinTime", _wrap_cDeepMimicCore_GetKinTime, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetName", _wrap_cDeepMimicCore_GetName, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_EnableDraw", _wrap_cDeepMimicCore_EnableDraw, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_Draw", _wrap_cDeepMimicCore_Draw, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_Keyboard", _wrap_cDeepMimicCore_Keyboard, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_MouseClick", _wrap_cDeepMimicCore_MouseClick, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_MouseMove", _wrap_cDeepMimicCore_MouseMove, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_Reshape", _wrap_cDeepMimicCore_Reshape, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_Shutdown", _wrap_cDeepMimicCore_Shutdown, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_IsDone", _wrap_cDeepMimicCore_IsDone, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetDrawScene", _wrap_cDeepMimicCore_GetDrawScene, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_SetPlaybackSpeed", _wrap_cDeepMimicCore_SetPlaybackSpeed, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_SetUpdatesPerSec", _wrap_cDeepMimicCore_SetUpdatesPerSec, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetWinWidth", _wrap_cDeepMimicCore_GetWinWidth, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetWinHeight", _wrap_cDeepMimicCore_GetWinHeight, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetNumUpdateSubsteps", _wrap_cDeepMimicCore_GetNumUpdateSubsteps, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_IsRLScene", _wrap_cDeepMimicCore_IsRLScene, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetNumAgents", _wrap_cDeepMimicCore_GetNumAgents, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_NeedNewAction", _wrap_cDeepMimicCore_NeedNewAction, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_RecordState", _wrap_cDeepMimicCore_RecordState, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_RecordGoal", _wrap_cDeepMimicCore_RecordGoal, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_SetAction", _wrap_cDeepMimicCore_SetAction, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_LogVal", _wrap_cDeepMimicCore_LogVal, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetActionSpace", _wrap_cDeepMimicCore_GetActionSpace, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetStateSize", _wrap_cDeepMimicCore_GetStateSize, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetGoalSize", _wrap_cDeepMimicCore_GetGoalSize, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetActionSize", _wrap_cDeepMimicCore_GetActionSize, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetNumActions", _wrap_cDeepMimicCore_GetNumActions, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildStateOffset", _wrap_cDeepMimicCore_BuildStateOffset, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildStateScale", _wrap_cDeepMimicCore_BuildStateScale, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildGoalOffset", _wrap_cDeepMimicCore_BuildGoalOffset, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildGoalScale", _wrap_cDeepMimicCore_BuildGoalScale, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildActionOffset", _wrap_cDeepMimicCore_BuildActionOffset, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildActionScale", _wrap_cDeepMimicCore_BuildActionScale, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildActionBoundMin", _wrap_cDeepMimicCore_BuildActionBoundMin, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildActionBoundMax", _wrap_cDeepMimicCore_BuildActionBoundMax, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildStateNormGroups", _wrap_cDeepMimicCore_BuildStateNormGroups, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_BuildGoalNormGroups", _wrap_cDeepMimicCore_BuildGoalNormGroups, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_CalcReward", _wrap_cDeepMimicCore_CalcReward, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetRewardMin", _wrap_cDeepMimicCore_GetRewardMin, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetRewardMax", _wrap_cDeepMimicCore_GetRewardMax, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetRewardFail", _wrap_cDeepMimicCore_GetRewardFail, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_GetRewardSucc", _wrap_cDeepMimicCore_GetRewardSucc, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_IsEpisodeEnd", _wrap_cDeepMimicCore_IsEpisodeEnd, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_CheckValidEpisode", _wrap_cDeepMimicCore_CheckValidEpisode, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_CheckTerminate", _wrap_cDeepMimicCore_CheckTerminate, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_SetMode", _wrap_cDeepMimicCore_SetMode, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_SetSampleCount", _wrap_cDeepMimicCore_SetSampleCount, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_PrintArgs", _wrap_cDeepMimicCore_PrintArgs, METH_VARARGS, NULL},
	 { (char *)"cDeepMimicCore_swigregister", cDeepMimicCore_swigregister, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_cTextureDesc = {"_p_cTextureDesc", "cTextureDesc *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t = {"_p_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t", "std::map< std::string,std::vector< std::string > >::allocator_type *|std::allocator< std::pair< std::string const,std::vector< std::string,std::allocator< std::string > > > > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t,
...
static swig_cast_info _swigc__p_cTextureDesc[] = {  {&_swigt__p_cTextureDesc, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t[] = {  {&_swigt__p_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_std__allocatorT_std__pairT_std__string_const_std__vectorT_std__string_std__allocatorT_std__string_t_t_t_t,
